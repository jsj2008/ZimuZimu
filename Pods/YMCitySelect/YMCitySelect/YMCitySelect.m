...
-(void)ym_setNavView{
    ...
    [closeBtn setImage:[UIImage imageNamed:@"btn_navigation_close_hl" inBundle:_YMBundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [closeBtn setImage:[UIImage imageNamed:@"btn_navigation_close" inBundle:_YMBundle compatibleWithTraitCollection:nil] forState:UIControlStateHighlighted];
...
-(void)ym_setCityGroups{
    NSString *path = [_YMBundle pathForResource:@"cityGroups.plist" ofType:nil];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    ym_view.backgroundColor = [UIColor colorWithRed:243/255.0 green:243/255.0 blue:243/255.0 alpha:1.0];
    UILabel *ym_label = [[UILabel alloc] init];
    ym_label.textAlignment = NSTextAlignmentLeft;
    ym_label.textColor = [UIColor lightGrayColor];
    ym_label.font = [UIFont systemFontOfSize:14];
    YMCityGroupsModel *cityGroupModel = _ym_ctiyGroups[section];
